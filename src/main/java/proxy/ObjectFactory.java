...
public class ObjectFactory {
    ...
    private static final QName _Compte_QNAME = new QName("http://ws.mrurespect.fsts/", "compte");
    private static final QName _Conversion_QNAME = new QName("http://ws.mrurespect.fsts/", "conversion");
    private static final QName _ConversionResponse_QNAME = new QName("http://ws.mrurespect.fsts/", "conversionResponse");
    private static final QName _GetCompte_QNAME = new QName("http://ws.mrurespect.fsts/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://ws.mrurespect.fsts/", "getCompteResponse");
    private static final QName _ListComptes_QNAME = new QName("http://ws.mrurespect.fsts/", "listComptes");
    private static final QName _ListComptesResponse_QNAME = new QName("http://ws.mrurespect.fsts/", "listComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.mrurespect.fsts/", name = "compte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.mrurespect.fsts/", name = "conversion")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.mrurespect.fsts/", name = "conversionResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.mrurespect.fsts/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.mrurespect.fsts/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.mrurespect.fsts/", name = "listComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.mrurespect.fsts/", name = "listComptesResponse")
