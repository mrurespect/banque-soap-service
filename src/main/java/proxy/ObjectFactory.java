...
public class ObjectFactory {
    ...
    private final static QName _Compte_QNAME = new QName("http://ws.mrurespect.fsts/", "compte");
    private final static QName _Conversion_QNAME = new QName("http://ws.mrurespect.fsts/", "conversion");
    private final static QName _ConversionResponse_QNAME = new QName("http://ws.mrurespect.fsts/", "conversionResponse");
    private final static QName _GetCompte_QNAME = new QName("http://ws.mrurespect.fsts/", "getCompte");
    private final static QName _GetCompteResponse_QNAME = new QName("http://ws.mrurespect.fsts/", "getCompteResponse");
    private final static QName _ListComptes_QNAME = new QName("http://ws.mrurespect.fsts/", "listComptes");
    private final static QName _ListComptesResponse_QNAME = new QName("http://ws.mrurespect.fsts/", "listComptesResponse");
